...
challenges = Challenge.create!(
  ...
  { title: "Combo Wellness: Complete todos os desafios da trilha wellness uma vez:", points: 50 },
  { title: "Combo Vendas 1: Complete os desafios Venda de Aulas e Encaminhe para um Personal:", points: 90 },
  { title: "Combo Vendas 2: Complete os desafios Encaminhe para um Nutricionista e Venda de Suplementos", points: 90 },
  { title: "Combo Vendas 3: Complete os desafios Encaminhe para o SPA e Encaminhe para um Fisioterapeuta", points: 90 },
  { title: "Combo Vendas 4: Complete os desafios Encaminhe para um Massagista e Venda de Suplementos", points: 90 }, 
  { title: "Combo Vendas 5: Complete os desafios Encaminhe para um Nutricionista e Encaminhe para o SPA", points: 90 },
  { title: "Combo Vendas 6: Complete os desafios Encaminhe para um Fisioterapeuta e Encaminhe para um Massagista", points: 90 },
  { title: "Combo Vendas 7: Complete os desafios Venda de Suplementos e Encaminhe para um Fisioterapeuta", points: 90 },
  { title: "Combo Vendas 8: Complete os desafios Encaminhe para um Nutricionista e Encaminhe para um Massagista", points: 90 },
  { title: "Combo Vendas 9: Complete os desafios Venda de Aulas e Encaminhe para um Nutricionista", points: 90 },
  { title: "Combo Vendas 10: Complete os desafios Venda de Aulas e Encaminhe para um Fisioterapeuta", points: 90 }, 
  { title: "Combo Vendas 11: Complete os desafios Encaminhe para um Nutricionista e Encaminhe para um Personal", points: 90 },
  { title: "Combo Vendas 12: Complete os desafios Encaminhe para um SPA e Encaminhe para um Fisioterapeuta", points: 90 },
  { title: "Combo Vendas 13: Complete os desafios Encaminhe para um Nutricionista e Encaminhe para um Fisioterapeuta", points: 90 },
  ...
  { title: "Combo Vendas 21: Complete os desafios Encaminhe para um Personal e Venda de Suplementos", points: 90 },
  { title: "Combo Vendas 22: Complete os desafios Venda de Aulas, Encaminhe para um Personal e Encaminhe para um Nutricionista", points: 130 },
  { title: "Combo Vendas 23: Complete os desafios Venda de Aulas, Venda de Suplementos e Encaminhe para o SPA", points: 130 },
  { title: "Combo Vendas 24: Complete os desafios Venda de Aulas, Encaminhe para um Fisioterapeuta e Encaminhe para um Massagista", points: 130 },
  { title: "Combo Vendas 25: Complete os desafios Encaminhe para um Personal, Encaminhe para um Nutricionista e Venda de Suplementos", points: 130 },
  { title: "Combo Vendas 26: Complete os desafios Encaminhe para um Personal, Encaminhe para o SPA e Encaminhe para um Fisioterapeuta", points: 130 },
